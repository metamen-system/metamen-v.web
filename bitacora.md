...
- Nota operativa para futuras auditorías de permisos: incluir ambas verificaciones.
  1. `git ls-files -s` → valida el modo en git (verificación principal).
  2. `test -x` → usar solo como verificación secundaria en entornos POSIX.

## M01-089

- Título: Configurar lint-staged
- Fecha completación: 2026-04-08
- Score auditoría: 100%
- Tipo de aprobación: PRIMERA AUDITORÍA
